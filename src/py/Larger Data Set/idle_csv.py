...
# 27/01/2026
# idle_csv.py
# Records IDLE accelerometer data from Arduino and appends to idle.csv

# Import serial module to communicate with Arduino via USB
import serial
...
FILENAME = "idle.csv"  # CSV file to save the recorded idle data
...
with open(FILENAME, "a") as f:
    ...
    print("Recording IDLE data... Press Ctrl+C to stop.")
